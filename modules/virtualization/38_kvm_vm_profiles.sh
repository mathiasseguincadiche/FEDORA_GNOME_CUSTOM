...
- Ubuntu Server 26.04 LTS (ubuntu-devops): 6 vCPU, 16 GiB RAM, 160 GiB qcow2, UEFI, VirtIO, cloud-init, SSH and dedicated DevOps bootstrap
...
- no host-directory sharing layer is configured; access to Ubuntu guest files is through SSH/SFTP
