...
engine_bootstrap() {
  ...
  source "$REPO_ROOT/lib/hardware_platform.sh"
  source "$REPO_ROOT/lib/driver_contract.sh"
  source "$REPO_ROOT/lib/kvm_contract.sh"
  source "$REPO_ROOT/lib/application_runtime.sh"
