...
grep -Fq 'install_manifest_packages GNOME "$REPO_ROOT/manifests/packages-gnome-extensions.txt"' "$ROOT/modules/gnome/24_gnome_extensions.sh"
grep -Fq 'gnome-extensions enable "$uuid"' "$ROOT/modules/gnome/24_gnome_extensions.sh"
