...
for file in .github/workflows/non-regression.yml .github/workflows/fedora-host-pretest.yml .github/workflows/vm-pretest.yml .github/scripts/vm-pretest.sh; do [[ -f "$ROOT/$file" ]] || { echo "missing CI maturity file: $file" >&2; exit 1; }; done
grep -Fq 'fedora:44' "$ROOT/.github/workflows/fedora-host-pretest.yml"
grep -Fq 'Install complete Fedora-native contract' "$ROOT/.github/workflows/fedora-host-pretest.yml"
