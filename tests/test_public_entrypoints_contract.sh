...
public_entrypoints=(
  ...
  diagnostics/application-runtime-doctor diagnostics/applications-doctor diagnostics/backup-doctor diagnostics/baseline-doctor diagnostics/display-doctor diagnostics/driver-doctor diagnostics/final-certification diagnostics/gnome-doctor diagnostics/graphics-doctor diagnostics/kernel-doctor diagnostics/kvm-domain-doctor diagnostics/media-doctor diagnostics/nautilus-coldstart-doctor diagnostics/nautilus-integration-doctor diagnostics/ptyxis-doctor diagnostics/storage-doctor diagnostics/suspend-doctor diagnostics/virtualization-doctor diagnostics/virtualbox-gnome-lab-doctor diagnostics/workstation-doctor diagnostics/wsl2-doctor
  diagnostics/gnome-runtime-doctor diagnostics/localsearch-doctor diagnostics/nautilus-ptyxis-doctor diagnostics/ptyxis-integration-doctor diagnostics/default-apps-doctor diagnostics/portal-functional-doctor diagnostics/nautilus-vm-live-doctor diagnostics/gnome-desktop-integration-doctor
