...
grep -Fq 'ip -4 rule show' "$guard"
grep -Fq 'custom_policy_tables' "$guard"
grep -Fq 'policy_route_dump' "$guard"
grep -Fq 'policy_tables=' "$guard"
grep -Fq 'unsupported custom IPv4 rule without routing table' "$guard"
